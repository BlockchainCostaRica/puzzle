...
const ModalWindow = (props: any) => {
        ...
        payment: [
          {
            ...
            tokens:
              txData.pmt.amount /
              pool.tokenDecimals[pool.tokenIds.indexOf(txData.pmt.assetId)],
          },
        ],
      },
    })
  ...
  const toReceive = Math.floor(
    props.toReceive * pool.tokenDecimals[props.tokenOut]
  );

  return (
    <div>
      <button onClick={toggle} className="button primary large wide">
        {buttonLabel}
      </button>
      <div className="details__table">
        ...
        <div className="details__table--row">
          ...
          <div className="details__table--row-desc">
            <button
              className="button__icon-image"
              id="PopoverFocus"
              onClick={(e) => e.currentTarget.focus()}
            >
              <img src={newInfo} alt="icon" />
            </button>
            <UncontrolledPopover
            ...
            >
              <PopoverBody className="details__popover">
                ...
                <div className="details__popover--pair">
                  <div className="details__popover--pair-name">
                    Protocol fee:
                  </div>
      ...
      <Modal isOpen={modal} toggle={toggle} className={className + " mt-5"}>
        ...
        <ModalBody className="text-center">
          <button
            ...
            onClick={() =>
              exchangeWithSigner(txData, signerEmail.signer, toReceive).then(
                toggle
              )
            }
          >
          ...
          <button
            className="button secondary large wide button__icon"
            onClick={() =>
              exchangeWithSigner(txData, signerWeb.signer, toReceive).then(
                toggle
              )
            }
          >
          ...
          <button
            className="button secondary large wide button__icon"
            onClick={() => exchangeWithKeeper(txData, toReceive).then(toggle)}
          >
            Waves Keeper
