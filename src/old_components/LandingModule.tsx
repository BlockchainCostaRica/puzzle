...
export async function loadMainData() {
  ...
  for (const tokenName of Object.keys(appTokens)) {
    ...
    if (
      tokens
        ...
        .indexOf(token.tokenId) < 0
    ) {
      token["balance"] = Number(token["amount"]) / token["decimals"];
      token["price"] =
        Math.floor(100 * calculateTokenPrice(token, states)) / 100;
      tokens.push(token);
    }
  }
  ...
  const ducksApi = (
    await axios.get("https://wavesducks.com/api/v1/collective-farms")
  ).data;
  ...
  // const duxplorerApi = (
  //   await axios.get("https://duxplorer.com/collective/json")
  // ).data;
  for (const i of ducksApi) {
    tokenAddress[i.shareAssetId] = i.contract;
  }
      ...
      <div className="landing">
        <div className="landing__intro">
          <div className="landing__intro--lc">
            <h1 className="landing__title left">
              Decentralized&nbsp;exchange <br />
              of a newer generation
            </h1>
            <p className="landing__desc">Trade tokens in multiple mega pools</p>
            <Link to="/defi">
              <button className="button primary large">Trade</button>
            </Link>
          </div>
          <div className="landing__intro--rc">
            <img
              className="landing__intro--rc-image"
              src={landingImage}
              alt="img"
            />
          </div>
          <div
            className="landing__intro-more"
            onClick={() =>
              window.open(
                "https://medium.com/@izhur27/what-is-puzzle-swap-1e4b4af4ed17"
              )
            }
          >
            Learn more on
        ...
        <div className="landing__about">
          ...
          <h1 className="landing__title middle">
          ...
          <div className="landing__about--advantages">
            <div className="landing__about--advantages-item">
              ...
              <h2>Mega pools</h2>
              <p>
                Trade up to 10 tokens in one pool without extra fees and lower
                slippage risks. Any token can be exchanged to any other.
              </p>
            </div>
            <div className="landing__about--advantages-item">
              ...
              <p>
                Create a custom trading pool and provide liquidity from your
                portfolio with any token which is suitable for you.
              </p>
            </div>
            <div className="landing__about--advantages-item">
              ...
              <h2>Fair routing</h2>
              <p>
                Suitable routing service between custom pools and AMM-exchanges
                on Waves — trade with the best fare.
              </p>
            </div>
            <div className="landing__about--advantages-item">
              ...
              <p>
                Purchase subscriptions with PUZZLE to pay less fees if you are a
                regular user.
              </p>
            </div>
          </div>
        ...
        <div className="landing__traders">
          ...
          <h1 className="landing__title middle">
            Trade the best performing tokens
          </h1>
          <p className="landing__desc">
            Trade any share tokens and earn on holding them. Learn more on{" "}
            <a
              href="https://collective.wavesducks.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              collective.wavesducks.com
            </a>
          </p>
          ...
          <div className="landing__prices">
            ...
            {Object.keys(this.state.data.tokens).map((x: any) =>
              this.renderPriceRow(x)
            )}
        ...
        <div className="landing__invest">
          <div className="landing__invest--lc">
            ...
            <h1 className="landing__title">
              Be one of the first liquidity providers
              <br />
              in Puzzle MegaPools!
            </h1>
            <p className="landing__desc">
              ...
              <br />
              <a
                href="https://medium.com/@puzzleswap/liquidity-providing-is-live-at-puzzle-swap-5ffaed38e9f0"
                rel="noreferrer"
                target="_blank"
              >
                <strong>Learn more on our Medium</strong>
              </a>
              .
            </p>
            <Link to="/farms/addLiquidity">
              <button className="button primary large">Invest</button>
            </Link>
          </div>
          <div className="landing__invest--rc">
            <img
              className="landing__invest--rc-image"
              src={landingInvestImage}
              alt="img"
            />
          </div>
        </div>
